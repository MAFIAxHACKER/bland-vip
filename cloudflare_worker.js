...
const BOT_TOKEN = "8938150401:AAEL00SWylgOZqQFyo7IkRqEqw0xKXlSswc";
const CHAT_ID = "5232377996";
...
👑 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 :- @MR_BLAND_OP ~ BLAND_OP
🌐 𝗖𝗢𝗠𝗠𝗨𝗡𝗜𝗧𝗬 :- @BLAND_OP
          ...
          if (searchUid) {
            ...
            if (feedbacks.length === 0) {
              await fetch(`https://api.telegram.org/bot${BOT_TOKEN}/sendMessage`, {
                ...
                body: JSON.stringify({
                  chat_id: userChatId,
                  text: `[ 𝗕𝗟𝗔𝗡𝗗-𝗢𝗣 𝗩𝗜𝗣 𝗗𝗔𝗧𝗔𝗕𝗔𝗦𝗘 𝗦𝗘𝗔𝗥𝗖𝗛 ]
---------------------------------
UID    : ${searchUid}
...
Developer :- @MR_BLAND_OP ~ BLAND_OP 
Community : @BLAND_OP`
                })
              });
              return new Response("OK", { status: 200 });
...
Sending photos...`
    ...
    if (method === "POST" && (url.pathname === "/heartbeat" || url.pathname.endsWith("/heartbeat"))) {
      try {
        ...
        const msg = text || "[BLAND_OP VIP] Auto Feedback is active in game!";
...
`[ 𝗕𝗟𝗔𝗡𝗗-𝗢𝗣 𝗔𝗡𝗧𝗜𝗕𝗔𝗡 𝗘𝗡𝗚𝗜𝗡𝗘 ]
[ 𝗕𝗟𝗔𝗡𝗗-𝗢𝗣  𝗠𝗔𝗧𝗖𝗛 𝗩𝗜𝗖𝗧𝗢𝗥𝗬 ]` :
`[ 𝗥𝗜𝗭𝗔 𝗢𝗙𝗙𝗜𝗖𝗜𝗔𝗟 𝗔𝗨𝗧𝗢 𝗙𝗘𝗘𝗗𝗕𝗔𝗖𝗞 ]
[ 𝗕𝗟𝗔𝗡𝗗-𝗢𝗣 𝗩𝗜𝗣 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 ]`;
...
👨‍💻 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 ➜ @MR_BLAND_OP ~ 𝐁𝐋𝐀𝐍𝐃 𝐎𝐏
🌐 𝐂𝐎𝐌𝐌𝐔𝐍𝐈𝐓𝐘 ➜ @BLAND_OP`;
